...
UserSchema.statics.authenticateLocal = function() {
  ...
  return function(req, email, password, cb) {
    // findByUsername est une fonction fournie par passeport pour chercher un utilisateur
    // Étant donné que nous nous basons sur l'email, cette fonction cherchera par email
